...
<html lang='en'>
	<head>
		<title>Doctors Discharged Patients</title>
		<!--fontawesome cdn-->
...
<div class="container">
	...
	<div class="profile">
		<h2 style="padding-left:40%">Discharged Patients</h2>
		<?php 
		$query ="SELECT * FROM appointment WHERE status='Discharged' ";
			...
			$output .="
						<tbody>
							<tr>
								...
								<td>$date_booked</td>
								<td>
									<a href='./patient_history.php?id=".$row['id']."'><button style='background:#0298cf; color:#fff;'>View</button></a>
								</td>
