...
<html lang='en'>
	<head>
		<title>Doctors Ambulance request</title>
		<!--fontawesome cdn-->
...
<div class="container">
	...
	<div class="profile">
		<h2 style="padding-left:40%">AMBULANCE EMERGENCY REQUEST</h2>
		<?php 
			...
			$output .="
						<tbody>
							<tr>
								...
								<td>$date_booked</td>
								<td>
									<a href='emergency_bill.php?id=".$row['id']."'><button style='background:#0298cf; color:#fff;'>Check</button></a>
								</td>
