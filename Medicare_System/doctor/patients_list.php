...
<html lang='en'>
	<head>
		<title>Doctors Patient List</title>
		<!--fontawesome cdn-->
...
<div class="container">
	...
	<div class="profile">
		<h2 style="padding-left:40%">Patients Lists</h2>
		<?php 
					...
					$output .="
						<tbody>
							<tr>
								...
								<td>$date_reg</td>
								<td>
									<a href='patientlist_view.php?id=".$row['id']."'><button style='background:#0298cf; color:#fff;'>View</button></a>
								</td>
