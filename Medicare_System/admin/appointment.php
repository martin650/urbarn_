	...
	<body>
		...
		<div class="admin">
			<div class="admin-header">
				<p style="padding-left:40%; text-decoration:underline;">ALL APPOINTMENTS</p>
				<div>
				</div>
			</div>
		</div>
					...
					$output .="
						<tbody>
							<tr>
								...
								<td>$date_booked</td>
								<td>
									<a href='appointment_view.php?id=".$row['id']."'><button style='background:#0298cf; color:#fff;'>View</button></a>
								</td>
