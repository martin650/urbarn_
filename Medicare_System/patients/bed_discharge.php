...
<div class="container">
	...
	<div class="profile">
		<h2 style="padding-left:40%">My Allocated bed space</h2>
		<?php
		...
		$querys = mysqli_query($conn, "SELECT * FROM bed WHERE surname='$sname' && status='Active'");
		$output = "";
					...
					$output .="
						<tbody>
							<tr>
								...
								<td>$status</td>
								<td>
									<a href='bed_view.php?id=".$row['id']."'><button style='background:#0298cf; color:#fff;'>View</button></a>
								</td>
			";
		}
		$output .="</tr></table>";
