...
<div class="container">
	...
	<div class="content">
		<div class="cards">
			...
			<div class="card">
				<div class="box">
					<a href="./ambulance_booked.php">
						<i class="fas fa-ambulance"></i><i class="fas fa-file-invoice"></i>
						<h3>Ambulance Record</h3>
					</a>
				</div>
				<div class="icon-case">
			...
			<div class="card">
				<div class="box">
					<a href="./bed_discharge.php">
						<i class="fas fa-bed"></i>
						<h3>Booked Bed space</h3>
					</a>
				</div>
				<div class="icon-case">
